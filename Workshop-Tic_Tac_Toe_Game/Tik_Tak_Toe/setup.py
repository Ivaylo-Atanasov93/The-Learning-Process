from Tik_Tak_Toe.player import Player
from Tik_Tak_Toe.utils import decode_position
from Tik_Tak_Toe.validations import is_position_valid
...
def get_position(player, board):
    ...
    while not is_position_valid(position, board):
        position = int(input(f'{player} chooses a free position [1-9]: '))
